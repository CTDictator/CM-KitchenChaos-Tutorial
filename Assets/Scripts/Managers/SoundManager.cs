...
public class SoundManager : MonoBehaviour
{
    ...
    private void PlaySound(AudioClip audioClip, Vector3 position, float volumeModifier = 1f)
    {
        AudioSource.PlayClipAtPoint(audioClip, position, volumeModifier * volume);
    }
